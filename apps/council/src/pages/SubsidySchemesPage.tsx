    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6 text-slate-100">
      ...
      {loading ? (
        ...
        <div className="bg-slate-900/90 rounded-3xl p-12 text-center border border-slate-800 text-slate-400">
          ...
          <p className="text-xs mt-1 text-slate-500">
            Click "Launch New Fund Scheme" above to create your council's first fund pool.
          </p>
        </div>
      ) : (
      ...
      {showCreateModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md overflow-y-auto">
          <div className="bg-slate-900 rounded-3xl shadow-2xl border border-slate-800 max-w-lg w-full p-6 sm:p-8 relative animate-in fade-in-50 zoom-in-95 my-8 text-slate-100">
            <button
              type="button"
            ...
            <form onSubmit={handleCreateScheme} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-xs font-mono font-bold text-white focus:outline-none focus:border-emerald-500"
                    required
                  />
                </div>
                <div>
              ...
              <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-800">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-400 text-slate-950 font-black text-xs hover:from-emerald-400 hover:to-teal-300 shadow-md shadow-emerald-950/40 disabled:opacity-50"
                >
